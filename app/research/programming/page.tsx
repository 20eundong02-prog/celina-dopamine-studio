        ...
        <section id="project-puf" style={projectSectionStyle}>
          ...
          <div style={contentBoxStyle}>
            <div style={{ flex: 1, minWidth: "min(100%, 300px)" }}>
              ...
              <h3 style={headingStyle}>Logic & Trouble Shooting</h3>
              <ul style={listStyle}>
                <li>
              ...
              <h3 style={{...headingStyle, marginTop: "30px"}}>Impact</h3>
              <div
                style={{
                  background: "#FFF8FA",
                  padding: "15px 20px",
        ...
        <section id="project-rsoft" style={projectSectionStyle}>
          ...
          <div style={contentBoxStyle}>
            <div style={{ flex: 1, minWidth: "min(100%, 300px)" }}>
              ...
              <h3 style={headingStyle}>Key Logic</h3>
              <ul style={listStyle}>
                <li>
...
plt.hist(particle_sizes, bins=50)`}
        ...
        {/* ================================================================= */}
        {/* === [NEW] Project 4: Web Portfolio & Simulation (Side Project) === */}
        {/* ================================================================= */}
        <section
          style={{
            background: "white",
      ...
      <div style={{ textAlign: "center", marginTop: "clamp(50px, 10vh, 80px)" }}>
        <div style={{ display: "flex", justifyContent: "center", gap: "20px", flexWrap: "wrap", padding: "0 20px" }}>
          ...
          <a href="/research/education" style={primaryBtnStyle}>
            Next: Others →
          </a>
        </div>
      </div>
